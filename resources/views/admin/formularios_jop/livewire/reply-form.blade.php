<div>
    ...
    <div id="" class="formulario nuevo-formulario">
        ...
        @foreach ($formulario->preguntas as $index => $pregunta)
            ...
            <div class="div-formulario-n">
                ...
                <div class="opciones-pregunta grid-header-2">
                    <div class="row gap-37 padding-left-15">
                        <div class="modalFile__abrirBtn" wire:click="uploadFileModalRespuesta({{$pregunta->pre_id}})">
                            <i class="far fa-paperclip"></i>
            ...
            <div class="div-formulario-n">
                ...
                @foreach ($pregunta->opciones as $opcion)
                    <div class="row align-center preguntas-preview">
                        <input type="checkbox" wire:model.defer="selectedCheckboxes" value="{{$opcion->opc_id}}" wire:click="selectCheckbox({{$opcion->opc_id}})">
                        <p>{{ $opcion->opc_opcion }}</p>
                    </div>
                @endforeach
                <div class="opciones-pregunta grid-header-2">
            ...
            <div class="div-formulario-n">
                ...
                <div class="form-group">
                    <textarea name="" id="" class="form-control" cols="30" rows="10" wire:model.defer="res_parrafo" wire:change="updateParrafo({{$pregunta->pre_id}})" ></textarea>
                </div>
                <div class="opciones-pregunta grid-header-2">
                    <div class="row gap-37 padding-left-15">
                        <div class="modalFile__abrirBtn" wire:click="uploadFileModalRespuesta({{$pregunta->pre_id}})">
                        ...
                        <div class="div-formulario-n">
                            ...
                            <fieldset class="row row-responsive">
                                ...
                                <div class="col-sm-4 row-column-global sin-margen">
                                    <label for="mes_evaluacion">Mes de evaluación</label>
                                    <div class="form-group">
                                        <select wire:model.defer="res_mes" wire:change="updateHSE({{$pregunta->pre_id}})" id="mes_evaluacion" name="mes_evaluacion" class="form-control" tabindex="4" style="width: 100%;">
                                ...
                                <div class="col-sm-4 row-column-global sin-margen">
                                    ...
                                    <div class="form-group">
                                        <select wire:model.defer="res_ano" wire:change="updateHSE({{$pregunta->pre_id}})" id="anio" name="anio" class="form-control" tabindex="4" style="width: 100%;">
                                            <option value="">Seleccione</option>
                                            @php
                            ...
                            <fieldset class="row-global row-responsive">
                                ...
                                <div class="form-group">
                                    <input wire:model.defer="res_dotacion" wire:change="updateHSE({{$pregunta->pre_id}})" id="" name="" class="form-control" type="text" tabindex="1"
                                        placeholder="">
                                </div>
                            </fieldset>
                            ...
                            <fieldset class="row-global row-responsive">
                                ...
                                <div>
                                    <input wire:model.defer="res_documento_accidentabilidad" wire:change="updateHSE({{$pregunta->pre_id}})" class="form-control input-file-nuevo" id="" name=""type="file"
                                        tabindex="1">
                                </div>
                            </fieldset>
                            ...
                            <fieldset class="row-global row-responsive">
                                ...
                                <div class="form-group">
                                    <input wire:model.defer="res_dotacion_sub_contratos" wire:change="updateHSE({{$pregunta->pre_id}})" id="" name="" class="form-control" type="text" tabindex="1"
                                        placeholder="">
                                </div>
                            </fieldset>
                            ...
                            <fieldset class="row-global row-responsive">
                                ...
                                <div class="form-group">
                                    <input wire:model.defer="res_dotacion_nuevos" wire:change="updateHSE({{$pregunta->pre_id}})" id="" name="" class="form-control" type="text" tabindex="1"
                                        placeholder="">
                                </div>
                            </fieldset>
                            ...
                            <fieldset class="row-global row-responsive">
                                ...
                                <div class="form-group row-global">
                                    <div class="row-global align-center">
                                        <input wire:model.defer="res_documentacion_sub_contrato" wire:change="updateHSE({{$pregunta->pre_id}})" type="radio" name="sub_contrato" id="sub_contrato" value="1">
                                        <p>Si</p>
                                    </div>
                                    <div class="row-global align-center">
                                        <input wire:model.defer="res_documentacion_sub_contrato" wire:change="updateHSE({{$pregunta->pre_id}})" type="radio" name="sub_contrato" id="sub_contrato" value="0">
                                        <p>No</p>
                                    </div>
                                </div>
                            </fieldset>
                            ...
                            <fieldset class="row-global row-responsive">
                                ...
                                <div>
                                    <input wire:model.defer="res_documentacion" wire:change="updateHSE({{$pregunta->pre_id}})" class="form-control input-file-nuevo" id="" name=""type="file"
                                        tabindex="1">
    ...
    <div class="botones-formulario">
        <a href="{{route('formulario-jop.deshacer.respuesta')}}" class="modalFile__btnN modalFile__botonSecundario text-dark text-decoration-none">Deshacer todos los cambios</a>
        <button class="modalEnviar__abrirBtn modalFile__btnN modalFile__botonPrimario" id="responder-formulario">Enviar formulario</button>
    </div>
