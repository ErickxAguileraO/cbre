        ...
        <fieldset class="row">
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <p class="text-danger small" id="edificios_administrados_error"></p>
                </div>
            </div>
        </fieldset>
        <fieldset class="row">
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <input id="confia_en_nosotros" name="confia_en_nosotros" value="{{ $indicadores->ind_confia_en_nosotros }}" class="form-control"
                        type="text" tabindex="1" />
                    <p class="text-danger small" id="confia_en_nosotros_error"></p>
                </div>
            </div>
        </fieldset>
        <fieldset class="row">
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <input id="en_todo_chile" name="en_todo_chile" value="{{ $indicadores->ind_en_todo_chile }}" class="form-control"
                        type="text" tabindex="1" />
                    <p class="text-danger small" id="en_todo_chile_error"></p>
                </div>
            </div>
        </fieldset>
        <fieldset class="row">
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <input id="en_todo_chile2" name="en_todo_chile2" value="{{ $indicadores->ind_en_todo_chile2 }}" class="form-control"
                        type="text" tabindex="1" />
                    <p class="text-danger small" id="en_todo_chile2_error"></p>
                </div>
            </div>
        </fieldset>
