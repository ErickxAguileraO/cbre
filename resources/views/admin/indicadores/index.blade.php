        ...
        <fieldset class="row">
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <input id="edificios_administrados" name="edificios_administrados" value="{{ $indicadores->ind_administrados }}" class="form-control solo-numeros" data-maximo-caracteres="4"
        ...
        <fieldset class="row">
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <input id="confia_en_nosotros" name="confia_en_nosotros" value="{{ $indicadores->ind_confia_en_nosotros }}" class="form-control solo-numeros" data-maximo-caracteres="4"
                        type="text" tabindex="1" />
        ...
        <fieldset class="row">
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <input id="en_todo_chile" name="en_todo_chile" value="{{ $indicadores->ind_en_todo_chile }}" class="form-control solo-numeros" data-maximo-caracteres="4"
                        type="text" tabindex="1" />
