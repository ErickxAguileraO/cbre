                    ...
                    @elseif ($respuesta->pregunta->tipoPregunta->tipp_id == 4)
                        <div class="div-formulario-n">
                            ...
                            <fieldset class="row-global row-responsive">
                                ...
                                <div class="form-group">
                                    <input id="" name="" class="form-control" type="text" tabindex="1"
                                        placeholder="" disabled value="{{ $respuesta->res_dotacion }}">
                                </div>
                            </fieldset>
                            ...
                            <fieldset class="row-global row-responsive">
                                ...
                                <div>
                                    @if ($respuesta->res_documento_accidentabilidad)
                                        ...
                                        <a href="{{ $respuesta->getUrlDocumentoAccidentabilidad() }}"
                                            target="_blank" class="small">Descargar archivo adjunto</a>
                                    @else
                                        <input class="form-control input-file-nuevo" id=""
                                            name=""type="file" tabindex="1" disabled>
                                    @endif
                            ...
                            <fieldset class="row-global row-responsive">
                                ...
                                <div class="form-group">
                                    <input id="" name="" class="form-control" type="text" tabindex="1"
                                        placeholder="" disabled value="{{ $respuesta->res_dotacion_nuevos }}">
                                </div>
                            </fieldset>
...
{{--                 Contenedor solo con la estructura del formulario --}}
                <div class="contenedor-form-preguntas">
