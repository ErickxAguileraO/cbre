    ...
    <div class="txt-caracteristicas">
        <div class="txt">
            <div class="sub-menu">
                ...
                <p>></p>
                <a href="{{route('web.edificios.detalle', [$edificio->edi_id, Str::slug($edificio->edi_nombre , "
                    -")])}}">{{ $edificio->edi_nombre }}</a>
            </div>
        ...
        <div class="certificaciones-home">
            ...
            <div class="carruselCertificaciones">
                ...
                <div class="certificacion-home-n">
                    <a data-src="{{ $comercio->urlImagen }}" data-fancybox="comercio"
                        data-caption="<h2 style='text-align: center'>{{ $comercio->loc_nombre }}</h2><p style='text-align: center'>{{ $comercio->loc_descripcion }}</p>">
        ...
        <div class="ubicacion-edificio">
            <div>
                <div class="ubicacion-edificio-left-content">
                    ...
                    <p class="edificio-detalle-descripcion">@php echo
                        htmlspecialchars_decode($edificio->ubi_descripcion) @endphp</p>
                </div>
            </div>
            <div>
                <div id="map" data-latitud="{{ $edificio->edi_latitud }}" data-longitud="{{ $edificio->edi_longitud }}">
                </div>
            </div>
        </div>
    </section>
