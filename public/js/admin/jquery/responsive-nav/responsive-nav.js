  ...
  var nav,
    ...
    ResponsiveNav = function (el, options) {
      ...
      this.options = {
        ...
        label: "<i class='fas fa-circle-xmark fa-fw'></i> Cerrar",        // String: Label for the navigation toggle
  ...
  ResponsiveNav.prototype = {
    ...
    toggle: function () {
      if (!navOpen) {
		...
		$("#nav-toggle").addClass('close-menu');
		...
		$("#nav-toggle").removeClass('close-menu');
