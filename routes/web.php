...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::controller(FormularioAreaTecnicaController::class)->group(function () {
            ...
            Route::post('formulario-area-tecnica/observacion/{formulario}/{edificio?}', 'observacion')->name('formulario-area-tecnica.ver.observacion');
        ...
        Route::controller(MantencionesJOPController::class)->group(function () {
            ...
            Route::get('mantenciones-jop/get/archivos/{mantencion}/{zip}', 'zipArchivos')->name('mantenciones-jop.archivos');
        });
